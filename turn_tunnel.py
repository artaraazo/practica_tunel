...
class Monitor():
    ...
    def no_cars_north(self):
        return self.Ncars.value == 0 and (self.turn.value == 1 or self.Ncars_waiting.value == 0)
    
    def no_cars_south(self):
        return self.Scars.value == 0 and (self.turn.value == 0 or self.Scars_waiting.value == 0)
